...
🎯 IMPORT PATTERNS:
   ...
   from chuk_mcp_functions.math.number_theory import is_prime, gcd
   from chuk_mcp_functions.math.number_theory.primes import next_prime
   from chuk_mcp_functions.math.number_theory.modular_arithmetic import crt_solve
   
   # Or use submodules
   from chuk_mcp_functions.math import arithmetic, number_theory
