#!/usr/bin/env python3
# chuk_mcp_functions/math/trigonometry/__init__.py
"""
...
🎯 IMPORT PATTERNS:
   # Basic trigonometry
   from chuk_mcp_functions.math.trigonometry.basic_functions import sin, cos, tan
   from chuk_mcp_functions.math.trigonometry.inverse_functions import asin, atan2
   
   # Hyperbolic functions
   from chuk_mcp_functions.math.trigonometry.hyperbolic import sinh, cosh, tanh
   from chuk_mcp_functions.math.trigonometry.inverse_hyperbolic import asinh
   
   # Conversions and applications
   from chuk_mcp_functions.math.trigonometry.angle_conversion import degrees_to_radians
   from chuk_mcp_functions.math.trigonometry.applications import distance_haversine
