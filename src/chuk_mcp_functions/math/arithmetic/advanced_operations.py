#!/usr/bin/env python3
# chuk_mcp_functions/math/arithmetic/advanced_operations.py
"""
...
@mcp_function(
    ...
    examples=[
        ...
        {"input": {"x": 0.5}, "output": -0.6931471805599453, "description": "ln(0.5) = -ln(2)"}
    ]
)
...
@mcp_function(
    ...
    examples=[
        ...
        {"input": {"x": 1000, "base": 10}, "output": 3.0, "description": "log₁₀(1000) = 3"},
...
@mcp_function(
    ...
    execution_modes=["local", "remote"],
    examples=[
        {"input": {"number": 10, "base": 2}, "output": "1010", "description": "10 in binary"},
        {"input": {"number": 255, "base": 16}, "output": "FF", "description": "255 in hexadecimal"},
        {"input": {"number": 8, "base": 8}, "output": "10", "description": "8 in octal"},
        {"input": {"number": 100, "base": 3}, "output": "10201", "description": "100 in base 3"}
    ]
)
...
@mcp_function(
    ...
    execution_modes=["local", "remote"],
    examples=[
        {"input": {"number": "1010", "base": 2}, "output": 10, "description": "Binary 1010 to decimal"},
        {"input": {"number": "FF", "base": 16}, "output": 255, "description": "Hex FF to decimal"},
        {"input": {"number": "10", "base": 8}, "output": 8, "description": "Octal 10 to decimal"},
        {"input": {"number": "10201", "base": 3}, "output": 100, "description": "Base 3 to decimal"}
    ]
)
...
@mcp_function(
    ...
    execution_modes=["local", "remote"],
    examples=[
        {"input": {"dividend": 17, "divisor": 5}, "output": 3, "description": "17 ÷ 5 = 3 remainder 2"},
        {"input": {"dividend": 20, "divisor": 4}, "output": 5, "description": "20 ÷ 4 = 5 remainder 0"},
        {"input": {"dividend": -17, "divisor": 5}, "output": -4, "description": "Negative dividend"},
        {"input": {"dividend": 7, "divisor": 3}, "output": 2, "description": "7 ÷ 3 = 2 remainder 1"}
    ]
)
...
@mcp_function(
    ...
    examples=[
        {"input": {"numbers": [3, 2, 1]}, "output": 30, "description": "6! / (3! × 2! × 1!) = 30"},
        {"input": {"numbers": [2, 2]}, "output": 6, "description": "4! / (2! × 2!) = 6"},
        {"input": {"numbers": [4]}, "output": 1, "description": "4! / 4! = 1"},
        {"input": {"numbers": [1, 1, 1]}, "output": 6, "description": "3! / (1! × 1! × 1!) = 6"}
    ]
)
...
@mcp_function(
    ...
    execution_modes=["local", "remote"],
    examples=[
        {"input": {"arrays": [[1, 2, 3], [4, 5, 6]]}, "output": 32, "description": "1×4 + 2×5 + 3×6 = 32"},
        {"input": {"arrays": [[2, 3], [4, 5], [1, 2]]}, "output": 38, "description": "2×4×1 + 3×5×2 = 38"},
        {"input": {"arrays": [[1, 0, 1], [1, 1, 0]]}, "output": 1, "description": "1×1 + 0×1 + 1×0 = 1"},
...
@mcp_function(
    ...
    execution_modes=["local", "remote"],
    examples=[
        {"input": {"numbers": [1, 2, 3, 4]}, "output": 30, "description": "1² + 2² + 3² + 4² = 30"},
...
@mcp_function(
    ...
    execution_modes=["local", "remote"],
    examples=[
        {"input": {}, "output": 0.37454011884736246, "description": "Random float between 0 and 1"},
        {"input": {}, "output": 0.891773001115671, "description": "Another random float"},
        {"input": {}, "output": 0.19661193205945462, "description": "Random values vary each call"}
    ]
)
...
@mcp_function(
    ...
    execution_modes=["local", "remote"],
    examples=[
        {"input": {"min_val": 1, "max_val": 10}, "output": 7, "description": "Random int between 1 and 10"},
        {"input": {"min_val": -5, "max_val": 5}, "output": -2, "description": "Random int between -5 and 5"},
        {"input": {"min_val": 100, "max_val": 200}, "output": 156, "description": "Random int between 100 and 200"},
        {"input": {"min_val": 5, "max_val": 5}, "output": 5, "description": "Single value range"}
    ]
)
...
@mcp_function(
    ...
    execution_modes=["local", "remote"],
    examples=[
        {"input": {"rows": 2, "cols": 3}, "output": [[0.1, 0.5, 0.8], [0.3, 0.7, 0.2]], "description": "2x3 array of random floats"},
        {"input": {"rows": 1, "cols": 5}, "output": [[0.4, 0.9, 0.1, 0.6, 0.3]], "description": "1x5 array"},
        {"input": {"rows": 3, "cols": 1}, "output": [[0.7], [0.2], [0.8]], "description": "3x1 array"}
    ]
)
...
@mcp_function(
    ...
    cache_strategy="memory",
    examples=[
        {"input": {"numbers": [2, 3, 4]}, "output": 24, "description": "2 × 3 × 4 = 24"},
        {"input": {"numbers": [1, 2, 3, 4, 5]}, "output": 120, "description": "1 × 2 × 3 × 4 × 5 = 120"},
...
@mcp_function(
    ...
    cache_strategy="memory",
    examples=[
        {"input": {"number": 27}, "output": "XXVII", "description": "27 in Roman numerals"},
        {"input": {"number": 1994}, "output": "MCMXCIV", "description": "1994 in Roman numerals"},
...
@mcp_function(
    ...
    examples=[
        ...
        {"input": {"numeral": "MCMXCIV"}, "output": 1994, "description": "MCMXCIV to Arabic"},
...
@mcp_function(
    ...
    cache_strategy="memory",
    examples=[
        {"input": {"first": 1, "last": 10, "count": 10}, "output": 55, "description": "Sum 1+2+...+10"},
        {"input": {"first": 2, "last": 20, "count": 10}, "output": 110, "description": "Sum of arithmetic series"},
        {"input": {"first": 5, "last": 5, "count": 1}, "output": 5, "description": "Single term"},
        {"input": {"first": 10, "last": 2, "count": 5}, "output": 30, "description": "Decreasing series"}
    ]
)
