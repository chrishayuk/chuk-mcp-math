#!/usr/bin/env python3
# chuk_mcp_functions/math/arithmetic/sequences.py
"""
...
@mcp_function(
    ...
    examples=[
        {"input": {"first_term": 2, "common_diff": 3, "num_terms": 5}, "output": [2, 5, 8, 11, 14], "description": "Arithmetic sequence starting at 2, diff 3"},
        {"input": {"first_term": 10, "common_diff": -2, "num_terms": 4}, "output": [10, 8, 6, 4], "description": "Decreasing arithmetic sequence"},
        {"input": {"first_term": 0, "common_diff": 1, "num_terms": 6}, "output": [0, 1, 2, 3, 4, 5], "description": "Natural numbers starting from 0"},
        {"input": {"first_term": 1, "common_diff": 0, "num_terms": 3}, "output": [1, 1, 1], "description": "Constant sequence"}
    ]
)
async def arithmetic_sequence(first_term: Number, common_diff: Number, num_terms: int) -> List[Number]:
    """
...
@mcp_function(
    ...
    examples=[
        {"input": {"first_term": 2, "common_diff": 3, "num_terms": 5}, "output": 40, "description": "Sum of [2, 5, 8, 11, 14]"},
        {"input": {"first_term": 1, "common_diff": 1, "num_terms": 10}, "output": 55, "description": "Sum of first 10 natural numbers"},
        {"input": {"first_term": 5, "common_diff": 0, "num_terms": 4}, "output": 20, "description": "Sum of constant sequence"},
        {"input": {"first_term": 10, "common_diff": -1, "num_terms": 5}, "output": 40, "description": "Sum of decreasing sequence"}
    ]
)
...
@mcp_function(
    ...
    execution_modes=["local", "remote"],
    examples=[
        {"input": {"first_term": 2, "common_ratio": 3, "num_terms": 5}, "output": [2, 6, 18, 54, 162], "description": "Geometric sequence with ratio 3"},
        {"input": {"first_term": 1, "common_ratio": 0.5, "num_terms": 4}, "output": [1, 0.5, 0.25, 0.125], "description": "Decreasing geometric sequence"},
        {"input": {"first_term": 5, "common_ratio": 1, "num_terms": 3}, "output": [5, 5, 5], "description": "Constant geometric sequence"},
        {"input": {"first_term": 1, "common_ratio": -2, "num_terms": 4}, "output": [1, -2, 4, -8], "description": "Alternating geometric sequence"}
    ]
)
async def geometric_sequence(first_term: Number, common_ratio: Number, num_terms: int) -> List[Number]:
    """
...
@mcp_function(
    ...
    cache_strategy="memory",
    examples=[
        {"input": {"first_term": 2, "common_ratio": 3, "num_terms": 5}, "output": 242, "description": "Sum of [2, 6, 18, 54, 162]"},
        {"input": {"first_term": 1, "common_ratio": 0.5, "num_terms": 10}, "output": 1.998046875, "description": "Sum of decreasing geometric sequence"},
        {"input": {"first_term": 1, "common_ratio": 0.5, "num_terms": None}, "output": 2.0, "description": "Infinite geometric series sum"},
        {"input": {"first_term": 3, "common_ratio": 1, "num_terms": 5}, "output": 15, "description": "Sum when ratio = 1"}
    ]
)
async def geometric_sum(first_term: Number, common_ratio: Number, num_terms: Optional[int] = None) -> Number:
    """
...
@mcp_function(
    ...
    cache_strategy="memory",
    examples=[
        {"input": {"n": 5}, "output": [1, 3, 6, 10, 15], "description": "First 5 triangular numbers"},
        {"input": {"n": 1}, "output": [1], "description": "First triangular number"},
        {"input": {"n": 8}, "output": [1, 3, 6, 10, 15, 21, 28, 36], "description": "First 8 triangular numbers"},
...
@mcp_function(
    ...
    cache_strategy="memory",
    examples=[
        {"input": {"n": 5}, "output": [1, 4, 9, 16, 25], "description": "First 5 square numbers"},
        {"input": {"n": 1}, "output": [1], "description": "First square number"},
        {"input": {"n": 7}, "output": [1, 4, 9, 16, 25, 36, 49], "description": "First 7 square numbers"},
        {"input": {"n": 0}, "output": [], "description": "Empty sequence"}
    ]
)
...
@mcp_function(
    ...
    cache_strategy="memory",
    examples=[
        {"input": {"n": 5}, "output": [1, 8, 27, 64, 125], "description": "First 5 cube numbers"},
        {"input": {"n": 1}, "output": [1], "description": "First cube number"},
        {"input": {"n": 6}, "output": [1, 8, 27, 64, 125, 216], "description": "First 6 cube numbers"},
        {"input": {"n": 0}, "output": [], "description": "Empty sequence"}
    ]
)
...
@mcp_function(
    ...
    examples=[
        ...
        {"input": {"n": 4}, "output": 2.083333333333333, "description": "H₄ = 1 + 1/2 + 1/3 + 1/4"},
...
@mcp_function(
    ...
    cache_strategy="memory",
    examples=[
        {"input": {"x": 2, "n": 4}, "output": 31, "description": "1 + 2 + 4 + 8 + 16 = 31"},
        {"input": {"x": 0.5, "n": 3}, "output": 1.875, "description": "1 + 0.5 + 0.25 + 0.125 = 1.875"},
        {"input": {"x": 1, "n": 5}, "output": 6, "description": "1 + 1 + 1 + 1 + 1 + 1 = 6"},
...
@mcp_function(
    ...
    execution_modes=["local", "remote"],
    examples=[
        {"input": {"sequence": [1, 4, 9, 16, 25]}, "output": [3, 5, 7, 9], "description": "Differences in square numbers"},
        {"input": {"sequence": [2, 5, 8, 11, 14]}, "output": [3, 3, 3, 3], "description": "Constant differences (arithmetic)"},
        {"input": {"sequence": [1, 2, 4, 8, 16]}, "output": [1, 2, 4, 8], "description": "Differences in powers of 2"},
        {"input": {"sequence": [10]}, "output": [], "description": "Single element sequence"}
    ]
)
...
@mcp_function(
    ...
    execution_modes=["local", "remote"],
    examples=[
        {"input": {"sequence": [2, 5, 8, 11, 14]}, "output": True, "description": "Arithmetic sequence with diff 3"},
        {"input": {"sequence": [1, 4, 9, 16, 25]}, "output": False, "description": "Square numbers (not arithmetic)"},
        {"input": {"sequence": [10, 10, 10]}, "output": True, "description": "Constant sequence (diff 0)"},
        {"input": {"sequence": [1]}, "output": True, "description": "Single element (trivially arithmetic)"}
    ]
)
...
@mcp_function(
    ...
    execution_modes=["local", "remote"],
    examples=[
        {"input": {"sequence": [2, 6, 18, 54]}, "output": True, "description": "Geometric sequence with ratio 3"},
        {"input": {"sequence": [1, 2, 4, 7]}, "output": False, "description": "Not geometric"},
        {"input": {"sequence": [5, 5, 5]}, "output": True, "description": "Constant sequence (ratio 1)"},
        {"input": {"sequence": [1, -2, 4, -8]}, "output": True, "description": "Alternating geometric sequence"}
    ]
)
