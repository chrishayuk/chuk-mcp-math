...
@mcp_function(
    ...
    cache_strategy="memory",
    examples=[
        {"input": {"n": 10}, "output": [2, 1, 3, 4, 7, 11, 18, 29, 47, 76], "description": "First 10 Lucas numbers"},
        {"input": {"n": 5}, "output": [2, 1, 3, 4, 7], "description": "First 5 Lucas numbers"}
    ]
)
...
@mcp_function(
    ...
    estimated_cpu_usage="medium",
    examples=[
        {"input": {"n": 5, "P": 1, "Q": -1}, "output": [5, 11], "description": "U_5 and V_5 for Fibonacci/Lucas"},
        {"input": {"n": 4, "P": 2, "Q": -1}, "output": [6, 14], "description": "U_4 and V_4 for Pell sequences"},
        {"input": {"n": 3, "P": 3, "Q": 2}, "output": [13, 17], "description": "Custom Lucas sequences"}
    ]
)
...
@mcp_function(
    ...
    execution_modes=["local", "remote"],
    examples=[
        {"input": {"n": 10}, "output": [0, 1, 2, 5, 12, 29, 70, 169, 408, 985], "description": "First 10 Pell numbers"},
        {"input": {"n": 5}, "output": [0, 1, 2, 5, 12], "description": "First 5 Pell numbers"}
    ]
)
...
@mcp_function(
    ...
    examples=[
        {"input": {"coeffs": [1, 1], "initial": [0, 1], "n": 10}, "output": 55, "description": "Fibonacci: a_n = a_{n-1} + a_{n-2}"},
        {"input": {"coeffs": [2, 1], "initial": [0, 1], "n": 5}, "output": 29, "description": "Pell: a_n = 2*a_{n-1} + a_{n-2}"},
        {"input": {"coeffs": [1, 1, 1], "initial": [0, 0, 1], "n": 10}, "output": 149, "description": "Tribonacci: a_n = a_{n-1} + a_{n-2} + a_{n-3}"}
    ]
)
...
@mcp_function(
    ...
    execution_modes=["local", "remote"],
    examples=[
        {"input": {"coeffs": [1, 1]}, "output": [1, -1, -1], "description": "Fibonacci: x² - x - 1"},
        {"input": {"coeffs": [2, 1]}, "output": [1, -2, -1], "description": "Pell: x² - 2x - 1"},
        {"input": {"coeffs": [1, 1, 1]}, "output": [1, -1, -1, -1], "description": "Tribonacci: x³ - x² - x - 1"}
    ]
)
...
@mcp_function(
    ...
    estimated_cpu_usage="high",
    examples=[
        {"input": {"coeffs": [1, 1], "initial": [0, 1], "n": 10}, "output": 55.0, "description": "Fibonacci using Binet formula"},
        {"input": {"coeffs": [1], "initial": [2], "n": 5}, "output": 11.0, "description": "Lucas numbers"}
    ]
)
