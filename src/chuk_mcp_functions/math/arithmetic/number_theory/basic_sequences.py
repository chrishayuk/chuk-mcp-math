#!/usr/bin/env python3
# chuk_mcp_functions/math/arithmetic/number_theory/basic_sequences.py
"""
...
@mcp_function(
    ...
    cache_strategy="memory",
    examples=[
        {"input": {"n": 10}, "output": [0, 1, 4, 9, 16, 25, 36, 49, 64, 81], "description": "First 10 perfect squares"},
        {"input": {"n": 5}, "output": [0, 1, 4, 9, 16], "description": "First 5 perfect squares"}
    ]
)
...
@mcp_function(
    ...
    cache_strategy="memory",
    examples=[
        {"input": {"n": 5}, "output": 25, "description": "5th perfect square is 5² = 25"},
...
@mcp_function(
    ...
    cache_strategy="memory",
    examples=[
        {"input": {"n": 10}, "output": [1, 2, 4, 8, 16, 32, 64, 128, 256, 512], "description": "First 10 powers of two"},
        {"input": {"n": 5}, "output": [1, 2, 4, 8, 16], "description": "First 5 powers of two"}
    ]
)
...
@mcp_function(
    ...
    cache_strategy="memory",
    examples=[
        {"input": {"n": 4}, "output": 9, "description": "!4 = 9 derangements of 4 items"},
        {"input": {"n": 5}, "output": 44, "description": "!5 = 44 derangements of 5 items"},
        {"input": {"n": 0}, "output": 1, "description": "!0 = 1 by definition"}
    ]
)
...
@mcp_function(
    ...
    cache_strategy="memory",
    examples=[
        {"input": {"n": 10}, "output": [0, 1, 3, 6, 10, 15, 21, 28, 36, 45], "description": "First 10 triangular numbers"},
        {"input": {"n": 5}, "output": [0, 1, 3, 6, 10], "description": "First 5 triangular numbers"}
    ]
)
...
@mcp_function(
    ...
    cache_strategy="memory",
    examples=[
        {"input": {"n": 10}, "output": [0, 1, 5, 12, 22, 35, 51, 70, 92, 117], "description": "First 10 pentagonal numbers"},
        {"input": {"n": 5}, "output": [0, 1, 5, 12, 22], "description": "First 5 pentagonal numbers"}
    ]
)
...
@mcp_function(
    ...
    examples=[
        ...
        {"input": {"n": 10}, "output": 220, "description": "Sum of first 10 triangular numbers"},
        {"input": {"n": 0}, "output": 0, "description": "Sum of no triangular numbers is 0"}
    ]
)
