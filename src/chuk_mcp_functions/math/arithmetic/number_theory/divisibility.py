#!/usr/bin/env python3
# chuk_mcp_functions/math/arithmetic/number_theory/divisibility.py
"""
...
@mcp_function(
    ...
    cache_strategy="memory",
    examples=[
        {"input": {"a": 30, "b": 18}, "output": [6, -1, 2], "description": "gcd=6, 30×(-1) + 18×2 = 6"},
        {"input": {"a": 35, "b": 15}, "output": [5, 1, -2], "description": "gcd=5, 35×1 + 15×(-2) = 5"},
        {"input": {"a": 17, "b": 13}, "output": [1, -3, 4], "description": "gcd=1, 17×(-3) + 13×4 = 1"},
        {"input": {"a": 0, "b": 5}, "output": [5, 0, 1], "description": "gcd=5, 0×0 + 5×1 = 5"}
    ]
)
...
@mcp_function(
    ...
    estimated_cpu_usage="medium",
    examples=[
        {"input": {"n": 12}, "output": 6, "description": "12 has 6 divisors: 1,2,3,4,6,12"},
        {"input": {"n": 17}, "output": 2, "description": "Prime numbers have 2 divisors"},
