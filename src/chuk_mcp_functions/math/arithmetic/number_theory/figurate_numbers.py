#!/usr/bin/env python3
# chuk_mcp_functions/math/arithmetic/number_theory/figurate_numbers.py
"""
...
@mcp_function(
    ...
    examples=[
        {"input": {"n": 5, "s": 3}, "output": 15, "description": "5th triangular number"},
        {"input": {"n": 4, "s": 4}, "output": 16, "description": "4th square number"},
        {"input": {"n": 3, "s": 5}, "output": 12, "description": "3rd pentagonal number"},
        {"input": {"n": 6, "s": 6}, "output": 66, "description": "6th hexagonal number"}
    ]
)
...
@mcp_function(
    ...
    cache_strategy="memory",
    examples=[
        {"input": {"num": 15, "s": 3}, "output": True, "description": "15 is triangular"},
        {"input": {"num": 16, "s": 4}, "output": True, "description": "16 is square"},
        {"input": {"num": 13, "s": 5}, "output": False, "description": "13 is not pentagonal"},
        {"input": {"num": 28, "s": 6}, "output": True, "description": "28 is hexagonal"}
    ]
)
...
@mcp_function(
    ...
    execution_modes=["local", "remote"],
    examples=[
        {"input": {"n": 8, "s": 3}, "output": [0, 1, 3, 6, 10, 15, 21, 28], "description": "First 8 triangular numbers"},
        {"input": {"n": 6, "s": 5}, "output": [0, 1, 5, 12, 22, 35], "description": "First 6 pentagonal numbers"},
        {"input": {"n": 5, "s": 6}, "output": [0, 1, 6, 15, 28], "description": "First 5 hexagonal numbers"}
    ]
)
...
@mcp_function(
    ...
    cache_strategy="memory",
    examples=[
        {"input": {"n": 3, "s": 3}, "output": 10, "description": "3rd centered triangular"},
        {"input": {"n": 4, "s": 4}, "output": 25, "description": "4th centered square"},
        {"input": {"n": 2, "s": 6}, "output": 7, "description": "2nd centered hexagonal"},
        {"input": {"n": 5, "s": 5}, "output": 51, "description": "5th centered pentagonal"}
    ]
)
...
@mcp_function(
    ...
    execution_modes=["local", "remote"],
    examples=[
        {"input": {"n": 10}, "output": [0, 2, 6, 12, 20, 30, 42, 56, 72, 90], "description": "First 10 pronic numbers"},
        {"input": {"n": 5}, "output": [0, 2, 6, 12, 20], "description": "First 5 pronic numbers"}
    ]
)
...
@mcp_function(
    ...
    examples=[
        ...
        {"input": {"n": 4, "s": 3}, "output": 4, "description": "4th triangular gnomon"},
