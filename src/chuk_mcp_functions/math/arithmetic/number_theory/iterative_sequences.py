#!/usr/bin/env python3
# chuk_mcp_functions/math/arithmetic/number_theory/iterative_sequences.py
"""
...
@mcp_function(
    ...
    examples=[
        {"input": {"n": 7}, "output": [7, 22, 11, 34, 17, 52, 26, 13, 40, 20, 10, 5, 16, 8, 4, 2, 1], "description": "Collatz sequence for 7"},
        {"input": {"n": 3}, "output": [3, 10, 5, 16, 8, 4, 2, 1], "description": "Collatz sequence for 3"},
        {"input": {"n": 1}, "output": [1], "description": "Collatz sequence for 1"},
        {"input": {"n": 12}, "output": [12, 6, 3, 10, 5, 16, 8, 4, 2, 1], "description": "Collatz sequence for 12"}
    ]
)
...
@mcp_function(
    ...
    cache_strategy="memory",
    examples=[
        {"input": {"n": 7}, "output": 52, "description": "Max value in Collatz(7) is 52"},
        {"input": {"n": 3}, "output": 16, "description": "Max value in Collatz(3) is 16"},
        {"input": {"n": 27}, "output": 9232, "description": "Max value in Collatz(27) is 9232"}
    ]
)
...
@mcp_function(
    ...
    execution_modes=["local", "remote"],
    examples=[
        {"input": {"n": 1234, "digits": 4}, "output": [1234, 3087, 8352, 6174], "description": "Kaprekar sequence reaches 6174"},
        {"input": {"n": 495, "digits": 3}, "output": [495], "description": "495 is Kaprekar constant for 3 digits"},
        {"input": {"n": 1111, "digits": 4}, "output": [1111, 0], "description": "Repdigits lead to 0"}
    ]
)
...
@mcp_function(
    ...
    cache_strategy="memory",
    examples=[
        {"input": {"digits": 3}, "output": 495, "description": "Kaprekar constant for 3 digits"},
        {"input": {"digits": 4}, "output": 6174, "description": "Kaprekar constant for 4 digits"},
        {"input": {"digits": 6}, "output": 549945, "description": "Kaprekar constant for 6 digits"}
    ]
)
...
@mcp_function(
    ...
    estimated_cpu_usage="medium",
    examples=[
        {"input": {"limit": 50}, "output": [1, 7, 10, 13, 19, 23, 28, 31, 32, 44, 49], "description": "Happy numbers ≤ 50"},
        {"input": {"limit": 20}, "output": [1, 7, 10, 13, 19], "description": "Happy numbers ≤ 20"}
    ]
)
...
@mcp_function(
    ...
    examples=[
        ...
        {"input": {"n": 9474}, "output": True, "description": "9474 = 9⁴ + 4⁴ + 7⁴ + 4⁴"},
...
@mcp_function(
    ...
    examples=[
        {"input": {"limit": 1000}, "output": [1, 2, 3, 4, 5, 6, 7, 8, 9, 153, 371, 407], "description": "Narcissistic numbers ≤ 1000"},
        {"input": {"limit": 200}, "output": [1, 2, 3, 4, 5, 6, 7, 8, 9, 153], "description": "Narcissistic numbers ≤ 200"}
    ]
)
...
@mcp_function(
    ...
    execution_modes=["local", "remote"],
    examples=[
        {"input": {"start": "1", "terms": 5}, "output": ["1", "11", "21", "1211", "111221"], "description": "Look-and-say from 1"},
        {"input": {"start": "3", "terms": 4}, "output": ["3", "13", "1113", "3113"], "description": "Look-and-say from 3"},
        {"input": {"start": "11", "terms": 3}, "output": ["11", "21", "1211"], "description": "Look-and-say from 11"}
    ]
)
...
@mcp_function(
    ...
    execution_modes=["local", "remote"],
    examples=[
        {"input": {"n": 10}, "output": [0, 1, 3, 6, 2, 7, 13, 20, 12, 21], "description": "First 10 Recamán numbers"},
        {"input": {"n": 5}, "output": [0, 1, 3, 6, 2], "description": "First 5 Recamán numbers"}
    ]
)
...
@mcp_function(
    ...
    examples=[
        ...
        {"input": {"n": 197}, "output": True, "description": "197 is Keith: 1,9,7,17,33,57,107,197"},
...
@mcp_function(
    ...
    estimated_cpu_usage="high",
    examples=[
        {"input": {"limit": 1000}, "output": [14, 19, 28, 47, 61, 75, 197, 742, 1104], "description": "Keith numbers ≤ 1000"},
        {"input": {"limit": 100}, "output": [14, 19, 28, 47, 61, 75], "description": "Keith numbers ≤ 100"}
    ]
)
...
@mcp_function(
    ...
    execution_modes=["local", "remote"],
    examples=[
        {"input": {"n": 9875}, "output": [9875, 29, 11, 2], "description": "Digital sum sequence for 9875"},
        {"input": {"n": 123}, "output": [123, 6], "description": "Digital sum sequence for 123"},
...
@mcp_function(
    ...
    execution_modes=["local", "remote"],
    examples=[
        {"input": {"n": 39}, "output": [39, 27, 14, 4], "description": "Digital product sequence for 39"},
        {"input": {"n": 999}, "output": [999, 729, 126, 12, 2], "description": "Digital product sequence for 999"},
        {"input": {"n": 105}, "output": [105, 0], "description": "Contains 0, product becomes 0"}
    ]
)
