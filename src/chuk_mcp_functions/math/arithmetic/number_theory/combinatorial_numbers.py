#!/usr/bin/env python3
# chuk_mcp_functions/math/arithmetic/number_theory/combinatorial_numbers.py
"""
...
from .basic_sequences import factorial
...
@mcp_function(
    ...
    cache_strategy="memory",
    examples=[
        {"input": {"n": 6}, "output": [1, 1, 2, 5, 14, 42], "description": "First 6 Catalan numbers"},
        {"input": {"n": 10}, "output": [1, 1, 2, 5, 14, 42, 132, 429, 1430, 4862], "description": "First 10 Catalan numbers"}
    ]
)
...
@mcp_function(
    ...
    examples=[
        ...
        {"input": {"n": 20}, "output": False, "description": "20 is not a Catalan number"}
    ]
)
...
@mcp_function(
    ...
    cache_strategy="memory",
    examples=[
        {"input": {"n": 6}, "output": [1, 1, 2, 5, 15, 52], "description": "First 6 Bell numbers"},
        {"input": {"n": 8}, "output": [1, 1, 2, 5, 15, 52, 203, 877], "description": "First 8 Bell numbers"}
    ]
)
...
@mcp_function(
    ...
    estimated_cpu_usage="medium",
    examples=[
        {"input": {"n": 4}, "output": [[1], [1, 2], [2, 3, 5], [5, 7, 10, 15]], "description": "Bell triangle up to row 4"}
    ]
)
...
async def stirling_second(n: int, k: int) -> int:
    ...
    async def stirling_helper(n_val: int, k_val: int) -> int:
        ...
        if n_val == 0:
            ...
            result = (k_val * await stirling_helper(n_val - 1, k_val) + 
...
@mcp_function(
    ...
    cache_strategy="memory",
    examples=[
        {"input": {"n": 4}, "output": [0, 1, 7, 6, 1], "description": "Row 4: S(4,0) through S(4,4)"},
        {"input": {"n": 5}, "output": [0, 1, 15, 25, 10, 1], "description": "Row 5: S(5,0) through S(5,5)"}
    ]
)
...
@mcp_function(
    ...
    cache_strategy="memory",
    examples=[
        {"input": {"n": 4}, "output": [1, 6, 4, 1], "description": "Row 4 of Narayana triangle"},
        {"input": {"n": 5}, "output": [1, 10, 20, 10, 1], "description": "Row 5 of Narayana triangle"}
    ]
)
...
__all__ = [
    ...
    # Bell numbers
    'bell_number', 'bell_sequence', 'bell_triangle',
    
    # Stirling numbers
    'stirling_first', 'stirling_second', 'stirling_second_row',
    
    # Narayana numbers
    'narayana_number', 'narayana_triangle_row'
]
...
if __name__ == "__main__":
    ...
    async def test_combinatorial_numbers():
        ...
        print(f"  narayana_triangle_row(4) = {await narayana_triangle_row(4)}")  # Should be [1, 6, 4, 1]
