#!/usr/bin/env python3
# chuk_mcp_functions/math/arithmetic/core/modular.py
"""
...
@mcp_function(
    ...
    examples=[
        ...
        {"input": {"a": -17, "b": 5}, "output": [-4, 3], "description": "Negative dividend"},
        {"input": {"a": 7, "b": 3}, "output": [2, 1], "description": "7 ÷ 3 = 2 remainder 1"}
    ]
)
async def divmod_operation(a: Number, b: Number) -> Tuple[int, Number]:
    """
...
@mcp_function(
    ...
    execution_modes=["local", "remote"],
    examples=[
        {"input": {"x": 7.5, "y": 2.5}, "output": 0.0, "description": "IEEE remainder of 7.5 / 2.5"},
        {"input": {"x": 10.3, "y": 3.0}, "output": 1.3, "description": "IEEE remainder with decimals"},
        {"input": {"x": -7.5, "y": 2.5}, "output": 0.0, "description": "Negative dividend"},
        {"input": {"x": 5.0, "y": 2.0}, "output": 1.0, "description": "Simple remainder"}
    ]
)
...
@mcp_function(
    ...
    examples=[
        ...
        {"input": {"x": 10.3, "y": 3.0}, "output": 1.2999999999999998, "description": "Floating point precision"},
        {"input": {"x": -7.5, "y": 2.5}, "output": -0.0, "description": "Negative dividend"},
        {"input": {"x": 5.7, "y": 2.0}, "output": 1.7000000000000002, "description": "Float modulo"}
    ]
)
