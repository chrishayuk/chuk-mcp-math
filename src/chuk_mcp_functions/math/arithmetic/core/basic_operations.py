#!/usr/bin/env python3
# chuk_mcp_functions/math/arithmetic/core/basic_operations.py
"""
...
@mcp_function(
    ...
    examples=[
        ...
        {"input": {"a": -2.5, "b": 4.7}, "output": 2.2, "description": "Decimal addition"},
        {"input": {"a": 1e10, "b": 1e10}, "output": 2e10, "description": "Large numbers"}
    ]
)
...
@mcp_function(
    ...
    examples=[
        {"input": {"a": 6, "b": 7}, "output": 42, "description": "Integer multiplication"},
        {"input": {"a": 2.5, "b": 4}, "output": 10.0, "description": "Mixed decimal/integer"},
        {"input": {"a": -3, "b": 4}, "output": -12, "description": "Negative multiplication"}
    ]
)
...
@mcp_function(
    ...
    examples=[
        ...
        {"input": {"a": -10, "b": 2}, "output": -5.0, "description": "Negative division"}
    ]
)
...
@mcp_function(
    ...
    examples=[
        {"input": {"base": 2, "exponent": 3}, "output": 8, "description": "Integer power"},
        {"input": {"base": 4, "exponent": 0.5}, "output": 2.0, "description": "Fractional power (square root)"},
...
@mcp_function(
    ...
    examples=[
        ...
        {"input": {"x": 2}, "output": 1.4142135623730951, "description": "Irrational result"},
