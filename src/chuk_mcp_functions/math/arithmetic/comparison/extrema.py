#!/usr/bin/env python3
# chuk_mcp_functions/math/arithmetic/comparison/extrema.py
"""
...
@mcp_function(
    ...
    execution_modes=["local", "remote"],
    examples=[
        {"input": {"numbers": [3, 1, 4, 1, 5]}, "output": 1, "description": "Minimum of list"},
        {"input": {"numbers": [-2, 0, 1]}, "output": -2, "description": "Minimum with negatives"},
        {"input": {"numbers": [2.5, 1.1, 3.7]}, "output": 1.1, "description": "Minimum of floats"},
...
@mcp_function(
    ...
    execution_modes=["local", "remote"],
    examples=[
        {"input": {"numbers": [3, 1, 4, 1, 5]}, "output": 5, "description": "Maximum of list"},
        {"input": {"numbers": [-2, 0, 1]}, "output": 1, "description": "Maximum with negatives"},
        {"input": {"numbers": [2.5, 1.1, 3.7]}, "output": 3.7, "description": "Maximum of floats"},
        {"input": {"numbers": [42]}, "output": 42, "description": "Single element"}
    ]
)
...
if __name__ == "__main__":
    ...
    async def test_extrema_operations():
        ...
        print(f"sort_numbers({test_list}, descending=True) = {await sort_numbers(test_list, descending=True)}")
