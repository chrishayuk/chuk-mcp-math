#!/usr/bin/env python3
# chuk_mcp_functions/math/number_theory/farey_sequences.py
"""
...
@mcp_function(
    ...
    examples=[
        {"input": {"n": 5}, "output": [[0, 1], [1, 5], [1, 4], [1, 3], [2, 5], [1, 2], [3, 5], [2, 3], [3, 4], [4, 5], [1, 1]], "description": "Farey sequence F_5"},
        {"input": {"n": 3}, "output": [[0, 1], [1, 3], [1, 2], [2, 3], [1, 1]], "description": "Farey sequence F_3"},
        {"input": {"n": 4}, "output": [[0, 1], [1, 4], [1, 3], [1, 2], [2, 3], [3, 4], [1, 1]], "description": "Farey sequence F_4"}
    ]
)
...
@mcp_function(
    ...
    examples=[
        {"input": {"n": 5}, "output": {"length": 11, "formula_result": 11, "totient_sum": 10}, "description": "Length of F_5"},
        {"input": {"n": 10}, "output": {"length": 33, "formula_result": 33, "totient_sum": 32}, "description": "Length of F_10"},
        {"input": {"n": 8}, "output": {"length": 23, "formula_result": 23, "totient_sum": 22}, "description": "Length of F_8"}
    ]
)
...
@mcp_function(
    ...
    execution_modes=["local", "remote"],
    examples=[
        {"input": {"p": 1, "q": 2, "n": 5}, "output": {"left_neighbor": [2, 5], "right_neighbor": [3, 5], "mediant_left": [3, 7], "mediant_right": [4, 7]}, "description": "Neighbors of 1/2 in F_5"},
        {"input": {"p": 1, "q": 3, "n": 5}, "output": {"left_neighbor": [1, 4], "right_neighbor": [2, 5], "mediant_left": [2, 7], "mediant_right": [3, 8]}, "description": "Neighbors of 1/3 in F_5"}
    ]
)
async def farey_neighbors(p: int, q: int, n: int) -> Dict:
    ...
    result = {"fraction": [p, q], "position": position, "sequence_length": len(farey_seq)}
...
@mcp_function(
    ...
    cache_strategy="memory",
    examples=[
        {"input": {"p1": 1, "q1": 3, "p2": 1, "q2": 2}, "output": [2, 5], "description": "Mediant of 1/3 and 1/2"},
        {"input": {"p1": 2, "q1": 5, "p2": 3, "q2": 4}, "output": [5, 9], "description": "Mediant of 2/5 and 3/4"},
        {"input": {"p1": 0, "q1": 1, "p2": 1, "q2": 1}, "output": [1, 2], "description": "Mediant of 0/1 and 1/1"}
    ]
)
...
@mcp_function(
    ...
    execution_modes=["local", "remote"],
    examples=[
        {"input": {"target_p": 3, "target_q": 7}, "output": {"path": ["R", "L", "R"], "fractions": [[0, 1], [1, 1], [1, 2], [2, 3], [3, 7]], "depth": 4}, "description": "Path to 3/7 in Stern-Brocot tree"},
        {"input": {"target_p": 2, "target_q": 5}, "output": {"path": ["L", "R"], "fractions": [[0, 1], [1, 1], [1, 2], [2, 5]], "depth": 3}, "description": "Path to 2/5 in Stern-Brocot tree"}
    ]
)
...
@mcp_function(
    ...
    execution_modes=["local", "remote"],
    examples=[
        {"input": {"start_p": 1, "start_q": 3, "end_p": 1, "end_q": 2, "max_denom": 10}, "output": {"mediants": [[2, 5], [3, 7], [4, 9], [5, 11]], "converges": True, "steps": 4}, "description": "Mediant path from 1/3 to 1/2"},
        {"input": {"start_p": 0, "start_q": 1, "end_p": 1, "end_q": 4, "max_denom": 8}, "output": {"mediants": [[1, 5], [1, 4]], "converges": True, "steps": 2}, "description": "Mediant path from 0/1 to 1/4"}
    ]
)
async def farey_mediant_path(start_p: int, start_q: int, end_p: int, end_q: int, max_denom: int = 100) -> Dict:
    """
    ...
    return {
        ...
        "steps": len(mediants),
        "max_denom_used": max(med[1] for med in mediants) if mediants else 0,
        "reason": "Max denominator exceeded" if mediants and mediants[-1][1] >= max_denom else "Max steps exceeded"
    }
...
@mcp_function(
    ...
    estimated_cpu_usage="medium",
    examples=[
        {"input": {"n": 4}, "output": {"circles": [{"fraction": [0, 1], "center": [0, 0.5], "radius": 0.5}, {"fraction": [1, 4], "center": [0.25, 0.125], "radius": 0.125}], "count": 7}, "description": "Ford circles for F_4"},
        {"input": {"n": 3}, "output": {"circles": [{"fraction": [0, 1], "center": [0, 0.5], "radius": 0.5}, {"fraction": [1, 3], "center": [0.333, 0.167], "radius": 0.167}], "count": 5}, "description": "Ford circles for F_3"}
    ]
)
...
@mcp_function(
    ...
    execution_modes=["local", "remote"],
    examples=[
        {"input": {"n": 5}, "output": {"total_circles": 11, "tangent_pairs": 10, "max_radius": 0.5, "min_radius": 0.02, "avg_radius": 0.157}, "description": "Ford circle properties for F_5"},
        {"input": {"n": 3}, "output": {"total_circles": 5, "tangent_pairs": 4, "max_radius": 0.5, "min_radius": 0.167, "avg_radius": 0.267}, "description": "Ford circle properties for F_3"}
    ]
)
...
@mcp_function(
    ...
    cache_strategy="memory",
    examples=[
        {"input": {"p1": 1, "q1": 3, "p2": 1, "q2": 2}, "output": {"are_tangent": True, "distance": 0.375, "sum_radii": 0.375, "tangency_type": "external"}, "description": "Tangency between 1/3 and 1/2"},
        {"input": {"p1": 1, "q1": 4, "p2": 1, "q2": 3}, "output": {"are_tangent": True, "distance": 0.208, "sum_radii": 0.208, "tangency_type": "external"}, "description": "Tangency between 1/4 and 1/3"}
    ]
)
async def circle_tangency(p1: int, q1: int, p2: int, q2: int) -> Dict:
    ...
    return {
        ...
        "circle1": {"center": [round(center1_x, 6), round(center1_y, 6)], "radius": round(radius1, 6)},
        "circle2": {"center": [round(center2_x, 6), round(center2_y, 6)], "radius": round(radius2, 6)},
        "distance": round(distance, 8),
        "sum_radii": round(sum_radii, 8),
...
@mcp_function(
    ...
    estimated_cpu_usage="medium",
    examples=[
        {"input": {"n": 5}, "output": {"length": 11, "density": 0.55, "max_gap": 0.2, "avg_gap": 0.1, "adjacent_pairs": 10}, "description": "Properties of F_5"},
        {"input": {"n": 8}, "output": {"length": 23, "density": 0.719, "max_gap": 0.125, "avg_gap": 0.043, "adjacent_pairs": 22}, "description": "Properties of F_8"}
    ]
)
...
@mcp_function(
    ...
    examples=[
        {"input": {"max_n": 10}, "output": {"densities": [2, 3, 5, 7, 11, 13, 19, 23, 29, 33], "density_ratios": [1.5, 1.67, 1.4, 1.57, 1.18, 1.46, 1.21, 1.26, 1.14], "asymptotic_constant": 0.608}, "description": "Density analysis for n=1 to 10"},
        {"input": {"max_n": 5}, "output": {"densities": [2, 3, 5, 7, 11], "density_ratios": [1.5, 1.67, 1.4, 1.57], "asymptotic_constant": 0.61}, "description": "Density analysis for n=1 to 5"}
    ]
)
...
@mcp_function(
    ...
    execution_modes=["local", "remote"],
    examples=[
        {"input": {"n": 5}, "output": {"total_gaps": 10, "max_gap": 0.2, "min_gap": 0.033, "gap_distribution": {"0.033": 1, "0.067": 2, "0.1": 3, "0.2": 4}}, "description": "Gap analysis for F_5"},
        {"input": {"n": 7}, "output": {"total_gaps": 18, "max_gap": 0.143, "min_gap": 0.02, "gap_distribution": {"0.02": 1, "0.048": 3, "0.071": 5}}, "description": "Gap analysis for F_7"}
    ]
)
...
@mcp_function(
    ...
    execution_modes=["local", "remote"],
    examples=[
        {"input": {"target": 0.618, "max_denom": 10}, "output": {"best_approximation": [5, 8], "error": 0.007, "farey_order": 8}, "description": "Best approximation to φ-1 ≈ 0.618"},
        {"input": {"target": 0.333, "max_denom": 15}, "output": {"best_approximation": [1, 3], "error": 0.0003, "farey_order": 3}, "description": "Best approximation to 1/3"}
    ]
)
...
@mcp_function(
    ...
    execution_modes=["local", "remote"],
    examples=[
        {"input": {"p1": 1, "q1": 3, "p2": 1, "q2": 2}, "output": {"fraction_between": [2, 5], "is_mediant": True, "value": 0.4}, "description": "Fraction between 1/3 and 1/2"},
        {"input": {"p1": 2, "q1": 7, "p2": 1, "q2": 3}, "output": {"fraction_between": [3, 10], "is_mediant": True, "value": 0.3}, "description": "Fraction between 2/7 and 1/3"}
    ]
)
...
@mcp_function(
    ...
    execution_modes=["local", "remote"],
    examples=[
        {"input": {"p1": 1, "q1": 3, "p2": 1, "q2": 4}, "output": {"farey_sum": [7, 12], "regular_sum": [7, 12], "are_equal": True}, "description": "Farey sum of 1/3 and 1/4"},
        {"input": {"p1": 2, "q1": 5, "p2": 3, "q2": 7}, "output": {"farey_sum": [29, 35], "regular_sum": [29, 35], "are_equal": True}, "description": "Farey sum of 2/5 and 3/7"}
    ]
)
...
@mcp_function(
    ...
    execution_modes=["local", "remote"],
    examples=[
        {"input": {"levels": 3}, "output": {"tree_levels": [[[1, 1]], [[1, 2], [2, 1]], [[1, 3], [3, 2], [2, 3], [3, 1]]], "total_fractions": 7}, "description": "First 3 levels of Calkin-Wilf tree"},
        {"input": {"levels": 2}, "output": {"tree_levels": [[[1, 1]], [[1, 2], [2, 1]]], "total_fractions": 3}, "description": "First 2 levels of Calkin-Wilf tree"}
    ]
)
...
@mcp_function(
    ...
    estimated_cpu_usage="high",
    examples=[
        {"input": {"n": 10}, "output": {"farey_length": 33, "theoretical_length": 32.84, "error": 0.16, "rh_bound": 0.5}, "description": "RH connection for F_10"},
        {"input": {"n": 20}, "output": {"farey_length": 127, "theoretical_length": 126.32, "error": 0.68, "rh_bound": 0.447}, "description": "RH connection for F_20"}
    ]
)
...
async def demo_applications():
    ...
    for value, name in constants:
        if 0 <= value <= 1:
            ...
            print(f"   Best approximation: {approx['best_approximation'][0]}/{approx['best_approximation'][1]}")
    ...
    for ratio, name in musical_ratios:
        if ratio <= 2:  # Normalize to [0,1] range
            ...
            if 0 <= normalized <= 1:
                ...
                print(f"   Farey approximation: {approx['best_approximation'][0]}/{approx['best_approximation'][1]}")
    ...
    if 0 <= year_fraction <= 1:
        ...
        print(f"   Best rational: {year_approx['best_approximation'][0]}/{year_approx['best_approximation'][1]}")
