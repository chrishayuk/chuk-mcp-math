#!/usr/bin/env python3
# chuk_mcp_functions/math/number_theory/advanced_primality.py
"""
...
@mcp_function(
    ...
    examples=[
        {"input": {"n": 97, "k": 5}, "output": True, "description": "97 is prime with high confidence"},
        {"input": {"n": 561, "k": 5}, "output": False, "description": "561 is composite (Carmichael number)"},
        {"input": {"n": 2047, "k": 10}, "output": False, "description": "2047 is composite"},
...
@mcp_function(
    ...
    examples=[
        ...
        {"input": {"n": 561, "k": 5}, "output": False, "description": "561 is composite"},
        {"input": {"n": 15, "k": 3}, "output": False, "description": "15 is obviously composite"},
...
@mcp_function(
    ...
    examples=[
        {"input": {"n": 97, "k": 5}, "output": True, "description": "97 passes Fermat test"},
        {"input": {"n": 561, "k": 5}, "output": True, "description": "561 is Carmichael number (false positive)"},
        {"input": {"n": 15, "k": 3}, "output": False, "description": "15 fails Fermat test"},
        {"input": {"n": 101, "k": 5}, "output": True, "description": "101 passes Fermat test"}
    ]
)
...
@mcp_function(
    ...
    examples=[
        {"input": {"n": 17}, "output": True, "description": "17 is prime (deterministic)"},
        {"input": {"n": 15}, "output": False, "description": "15 is composite (deterministic)"},
        {"input": {"n": 97}, "output": True, "description": "97 is prime (deterministic)"},
        {"input": {"n": 25}, "output": False, "description": "25 is composite (deterministic)"}
    ]
)
...
@mcp_function(
    ...
    examples=[
        {"input": {"n": 97}, "output": True, "description": "97 is prime (deterministic)"},
        {"input": {"n": 561}, "output": False, "description": "561 is composite (deterministic)"},
        {"input": {"n": 2047}, "output": False, "description": "2047 is composite (deterministic)"},
        {"input": {"n": 1009}, "output": True, "description": "1009 is prime (deterministic)"}
    ]
)
...
@mcp_function(
    ...
    execution_modes=["local", "remote"],
    examples=[
        {"input": {"n": 2047, "bases": [2]}, "output": True, "description": "2047 is strong pseudoprime to base 2"},
        {"input": {"n": 1373653, "bases": [2, 3]}, "output": True, "description": "1373653 is strong pseudoprime to bases 2,3"},
        {"input": {"n": 97, "bases": [2, 3]}, "output": False, "description": "97 is prime, not pseudoprime"},
        {"input": {"n": 15, "bases": [2]}, "output": False, "description": "15 fails strong pseudoprime test"}
    ]
)
...
@mcp_function(
    ...
    execution_modes=["local", "remote"],
    examples=[
        {"input": {"n": 561}, "output": True, "description": "561 is the smallest Carmichael number"},
        {"input": {"n": 1105}, "output": True, "description": "1105 is a Carmichael number"},
        {"input": {"n": 1729}, "output": True, "description": "1729 is a Carmichael number"},
        {"input": {"n": 97}, "output": False, "description": "97 is prime, not Carmichael"}
    ]
)
...
__all__ = [
    # Probabilistic tests
    'miller_rabin_test', 'solovay_strassen_test', 'fermat_primality_test',
    
    # Deterministic tests
    'aks_primality_test', 'deterministic_miller_rabin',
    
    # Specialized tests
    'strong_pseudoprime_test', 'carmichael_number_test'
]
