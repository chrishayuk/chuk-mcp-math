#!/usr/bin/env python3
# chuk_mcp_functions/math/number_theory/special_number_categories.py
"""
...
@mcp_function(
    ...
    examples=[
        {"input": {"limit": 10000}, "output": [[220, 284], [1184, 1210], [2620, 2924], [5020, 5564], [6232, 6368]], "description": "Amicable pairs up to 10000"},
        {"input": {"limit": 1500}, "output": [[220, 284], [1184, 1210]], "description": "Amicable pairs up to 1500"},
        {"input": {"limit": 500}, "output": [[220, 284]], "description": "Amicable pairs up to 500"}
    ]
)
...
@mcp_function(
    ...
    examples=[
        {"input": {"n": 220}, "output": {"is_amicable": True, "partner": 284, "sum_of_divisors": 284}, "description": "220 is amicable with 284"},
        {"input": {"n": 284}, "output": {"is_amicable": True, "partner": 220, "sum_of_divisors": 220}, "description": "284 is amicable with 220"},
        {"input": {"n": 100}, "output": {"is_amicable": False, "sum_of_divisors": 117}, "description": "100 is not amicable"}
    ]
)
async def is_amicable_number(n: int) -> Dict:
    ...
    result = {
        ...
        "sum_of_divisors": sigma_n
    }
    
    if is_amicable:
        result["partner"] = sigma_n
        result["verification"] = f"σ({n}) = {sigma_n}, σ({sigma_n}) = {sigma_sigma_n}"
...
@mcp_function(
    ...
    examples=[
        {"input": {"limit": 30000, "max_chain_length": 10}, "output": {"chains": [{"length": 5, "chain": [12496, 14288, 15472, 14536, 14264], "type": "sociable"}], "total_chains": 1}, "description": "Sociable chains up to 30000"},
        {"input": {"limit": 15000, "max_chain_length": 8}, "output": {"chains": [], "total_chains": 0}, "description": "No sociable chains up to 15000"}
    ]
)
...
@mcp_function(
    ...
    examples=[
        {"input": {"n": 220, "max_steps": 10}, "output": {"sequence": [220, 284, 220], "type": "amicable_cycle", "cycle_length": 2, "reaches_cycle": True}, "description": "Aliquot sequence from 220"},
        {"input": {"n": 6, "max_steps": 5}, "output": {"sequence": [6, 6], "type": "perfect", "cycle_length": 1, "reaches_cycle": True}, "description": "Aliquot sequence from 6 (perfect)"},
        {"input": {"n": 12, "max_steps": 10}, "output": {"sequence": [12, 16, 15, 9, 4, 3, 1, 1], "type": "reaches_one", "reaches_cycle": False}, "description": "Aliquot sequence from 12"}
    ]
)
...
@mcp_function(
    ...
    estimated_cpu_usage="high",
    examples=[
        {"input": {"limit": 1000}, "output": [1, 9, 45, 55, 99, 297, 703, 999], "description": "Kaprekar numbers up to 1000"},
        {"input": {"limit": 100}, "output": [1, 9, 45, 55, 99], "description": "Kaprekar numbers up to 100"},
        {"input": {"limit": 10000}, "output": [1, 9, 45, 55, 99, 297, 703, 999, 2223, 2728, 4879, 4950, 5050, 5292, 7272, 7777, 9999], "description": "Kaprekar numbers up to 10000"}
    ]
)
...
@mcp_function(
    ...
    cache_strategy="memory",
    examples=[
        {"input": {"n": 45}, "output": {"is_kaprekar": True, "square": 2025, "splits": [{"left": 20, "right": 25, "sum": 45}]}, "description": "45 is Kaprekar: 45² = 2025, 20 + 25 = 45"},
        {"input": {"n": 297}, "output": {"is_kaprekar": True, "square": 88209, "splits": [{"left": 88, "right": 209, "sum": 297}]}, "description": "297 is Kaprekar: 297² = 88209, 88 + 209 = 297"},
        {"input": {"n": 10}, "output": {"is_kaprekar": False, "square": 100, "splits": []}, "description": "10 is not Kaprekar"}
    ]
)
...
@mcp_function(
    ...
    estimated_cpu_usage="extreme",
    examples=[
        {"input": {"limit": 200000}, "output": [{"vampire": 1260, "fangs": [[21, 60]]}, {"vampire": 1395, "fangs": [[15, 93]]}, {"vampire": 1435, "fangs": [[35, 41]]}, {"vampire": 1530, "fangs": [[30, 51]]}, {"vampire": 1827, "fangs": [[21, 87]]}, {"vampire": 2187, "fangs": [[27, 81]]}, {"vampire": 6880, "fangs": [[80, 86]]}, {"vampire": 102510, "fangs": [[201, 510]]}, {"vampire": 104260, "fangs": [[260, 401]]}, {"vampire": 105210, "fangs": [[210, 501]]}, {"vampire": 105264, "fangs": [[204, 516]]}, {"vampire": 105750, "fangs": [[150, 705]]}, {"vampire": 108135, "fangs": [[135, 801]]}, {"vampire": 110758, "fangs": [[158, 701]]}, {"vampire": 115672, "fangs": [[152, 761]]}, {"vampire": 116725, "fangs": [[161, 725]]}, {"vampire": 117067, "fangs": [[167, 701]]}, {"vampire": 118440, "fangs": [[141, 840]]}, {"vampire": 120600, "fangs": [[201, 600]]}, {"vampire": 123354, "fangs": [[231, 534]]}, {"vampire": 124483, "fangs": [[281, 443]]}, {"vampire": 125248, "fangs": [[152, 824]]}, {"vampire": 125433, "fangs": [[231, 543]]}, {"vampire": 125460, "fangs": [[204, 615], [246, 510]]}, {"vampire": 125500, "fangs": [[251, 500]]}, {"vampire": 186624, "fangs": [[186, 1002]]}], "description": "Vampire numbers up to 200000"},
        {"input": {"limit": 10000}, "output": [{"vampire": 1260, "fangs": [[21, 60]]}, {"vampire": 1395, "fangs": [[15, 93]]}, {"vampire": 1435, "fangs": [[35, 41]]}, {"vampire": 1530, "fangs": [[30, 51]]}, {"vampire": 1827, "fangs": [[21, 87]]}, {"vampire": 2187, "fangs": [[27, 81]]}, {"vampire": 6880, "fangs": [[80, 86]]}], "description": "Vampire numbers up to 10000"}
    ]
)
...
@mcp_function(
    ...
    execution_modes=["local", "remote"],
    examples=[
        {"input": {"n": 1260}, "output": {"is_vampire": True, "fangs": [[21, 60]], "digit_count": 4}, "description": "1260 is vampire: 21 × 60, digits rearrange"},
        {"input": {"n": 125460}, "output": {"is_vampire": True, "fangs": [[204, 615], [246, 510]], "digit_count": 6}, "description": "125460 has multiple fang pairs"},
        {"input": {"n": 1234}, "output": {"is_vampire": False, "fangs": [], "digit_count": 4}, "description": "1234 is not vampire"}
    ]
)
async def is_vampire_number(n: int) -> Dict:
    ...
    if n_digits % 2 != 0:
        return {"is_vampire": False, "fangs": [], "digit_count": n_digits, "reason": "Odd number of digits"}
...
@mcp_function(
    ...
    estimated_cpu_usage="high",
    examples=[
        {"input": {"limit": 10000}, "output": [1, 2, 3, 4, 5, 6, 7, 8, 9, 153, 370, 371, 407, 1634, 8208, 9474], "description": "Armstrong numbers up to 10000"},
        {"input": {"limit": 1000}, "output": [1, 2, 3, 4, 5, 6, 7, 8, 9, 153, 370, 371, 407], "description": "Armstrong numbers up to 1000"},
        {"input": {"limit": 100000}, "output": [1, 2, 3, 4, 5, 6, 7, 8, 9, 153, 370, 371, 407, 1634, 8208, 9474, 54748, 92727, 93084], "description": "Armstrong numbers up to 100000"}
    ]
)
...
@mcp_function(
    ...
    estimated_cpu_usage="high",
    examples=[
        {"input": {"limit": 100000}, "output": [1, 512, 4913, 5832, 17576, 19683], "description": "Dudeney numbers up to 100000"},
        {"input": {"limit": 10000}, "output": [1, 512, 4913, 5832], "description": "Dudeney numbers up to 10000"},
        {"input": {"limit": 1000}, "output": [1, 512], "description": "Dudeney numbers up to 1000"}
    ]
)
...
@mcp_function(
    ...
    estimated_cpu_usage="high",
    examples=[
        {"input": {"limit": 10000, "power": 4}, "output": [1, 1634, 8208, 9474], "description": "4th power PPDI numbers up to 10000"},
        {"input": {"limit": 1000, "power": 3}, "output": [1, 153, 371, 407], "description": "3rd power PPDI numbers up to 1000"},
        {"input": {"limit": 100000, "power": 5}, "output": [1, 4150, 4151, 54748, 92727, 93084], "description": "5th power PPDI numbers up to 100000"}
    ]
)
...
@mcp_function(
    ...
    estimated_cpu_usage="extreme",
    examples=[
        {"input": {"limit": 100000, "min_ways": 2}, "output": [{"number": 1729, "representations": [[1, 12], [9, 10]]}, {"number": 4104, "representations": [[2, 16], [9, 15]]}, {"number": 5832, "representations": [[9, 18], [10, 17]]}, {"number": 9729, "representations": [[1, 22], [18, 19]]}, {"number": 20683, "representations": [[10, 27], [19, 24]]}], "description": "Taxi numbers up to 100000"},
        {"input": {"limit": 10000, "min_ways": 2}, "output": [{"number": 1729, "representations": [[1, 12], [9, 10]]}, {"number": 4104, "representations": [[2, 16], [9, 15]]}, {"number": 5832, "representations": [[9, 18], [10, 17]]}, {"number": 9729, "representations": [[1, 22], [18, 19]]}], "description": "Taxi numbers up to 10000"}
    ]
)
async def taxi_numbers(limit: int, min_ways: int = 2) -> List[Dict]:
    ...
    # Sort by number
    taxi_nums.sort(key=lambda x: x["number"])
    return taxi_nums
...
@mcp_function(
    ...
    estimated_cpu_usage="high",
    examples=[
        {"input": {"limit": 1000}, "output": [14, 19, 28, 47, 61, 75, 197, 742, 1104], "description": "Keith numbers up to 1000"},
        {"input": {"limit": 100}, "output": [14, 19, 28, 47, 61, 75], "description": "Keith numbers up to 100"},
        {"input": {"limit": 10000}, "output": [14, 19, 28, 47, 61, 75, 197, 742, 1104, 1537, 2208, 2580, 3684, 4788, 7385, 7647, 7909], "description": "Keith numbers up to 10000"}
    ]
)
...
@mcp_function(
    ...
    execution_modes=["local", "remote"],
    examples=[
        {"input": {"n": 14}, "output": {"is_keith": True, "sequence": [1, 4, 5, 9, 14], "steps": 3}, "description": "14 is Keith: 1, 4, 5, 9, 14"},
        {"input": {"n": 197}, "output": {"is_keith": True, "sequence": [1, 9, 7, 17, 33, 57, 107, 197], "steps": 5}, "description": "197 is Keith with longer sequence"},
        {"input": {"n": 15}, "output": {"is_keith": False, "sequence": [1, 5, 6, 11, 22], "final_sum": 22}, "description": "15 is not Keith"}
    ]
)
async def is_keith_number(n: int) -> Dict:
    ...
    """
    if n < 10:
        return {"is_keith": False, "reason": "Keith numbers must have at least 2 digits"}
...
@mcp_function(
    ...
    cache_strategy="memory",
    examples=[
        {"input": {"n": 3}, "output": {"magic_constant": 15, "sum_formula": "n(n²+1)/2", "total_sum": 45}, "description": "3×3 magic square constant"},
        {"input": {"n": 4}, "output": {"magic_constant": 34, "sum_formula": "n(n²+1)/2", "total_sum": 136}, "description": "4×4 magic square constant"},
        {"input": {"n": 5}, "output": {"magic_constant": 65, "sum_formula": "n(n²+1)/2", "total_sum": 325}, "description": "5×5 magic square constant"}
    ]
)
...
@mcp_function(
    ...
    execution_modes=["local", "remote"],
    examples=[
        {"input": {"n": 153, "power": 3}, "output": {"digit_power_sum": 153, "digits": [1, 5, 3], "calculation": "1³ + 5³ + 3³ = 1 + 125 + 27"}, "description": "153 with power 3 (Armstrong number)"},
        {"input": {"n": 9474, "power": 4}, "output": {"digit_power_sum": 9474, "digits": [9, 4, 7, 4], "calculation": "9⁴ + 4⁴ + 7⁴ + 4⁴ = 6561 + 256 + 2401 + 256"}, "description": "9474 with power 4"},
        {"input": {"n": 123, "power": 2}, "output": {"digit_power_sum": 14, "digits": [1, 2, 3], "calculation": "1² + 2² + 3² = 1 + 4 + 9"}, "description": "123 with power 2"}
    ]
)
...
@mcp_function(
    ...
    execution_modes=["local", "remote"],
    examples=[
        {"input": {"n": 39}, "output": {"persistence": 3, "steps": [39, 27, 14, 4], "operation": "multiply"}, "description": "39 → 27 → 14 → 4 (3 steps)"},
        {"input": {"n": 999}, "output": {"persistence": 4, "steps": [999, 729, 126, 12, 2], "operation": "multiply"}, "description": "999 has persistence 4"},
        {"input": {"n": 99}, "output": {"persistence": 2, "steps": [99, 18, 8], "operation": "add"}, "description": "99 with addition: 99 → 18 → 8"}
    ]
)
...
__all__ = [
    ...
    # Kaprekar numbers
    'kaprekar_numbers', 'is_kaprekar_number',
    
    # Vampire numbers
    'vampire_numbers', 'is_vampire_number',
    
    # Armstrong numbers and variants
    'armstrong_numbers', 'dudeney_numbers', 'pluperfect_numbers',
    
    # Taxi numbers
    'taxi_numbers',
    
    # Keith numbers
    'keith_numbers', 'is_keith_number',
