#!/usr/bin/env python3
# chuk_mcp_functions/math/number_theory/number_systems.py
"""
...
@mcp_function(
    ...
    examples=[
        {"input": {"binary_str": "1010"}, "output": 10, "description": "Binary 1010 = Decimal 10"},
        {"input": {"binary_str": "11110000"}, "output": 240, "description": "Binary 11110000 = Decimal 240"},
        {"input": {"binary_str": "1"}, "output": 1, "description": "Binary 1 = Decimal 1"},
        {"input": {"binary_str": "0"}, "output": 0, "description": "Binary 0 = Decimal 0"}
    ]
)
...
@mcp_function(
    ...
    cache_strategy="memory",
    examples=[
        {"input": {"decimal": 10}, "output": "1010", "description": "Decimal 10 = Binary 1010"},
        {"input": {"decimal": 240}, "output": "11110000", "description": "Decimal 240 = Binary 11110000"},
...
@mcp_function(
    ...
    examples=[
        {"input": {"number": "1010", "from_base": 2, "to_base": 10}, "output": "10", "description": "Binary to decimal"},
        {"input": {"number": "FF", "from_base": 16, "to_base": 10}, "output": "255", "description": "Hex to decimal"},
        {"input": {"number": "255", "from_base": 10, "to_base": 16}, "output": "FF", "description": "Decimal to hex"},
        {"input": {"number": "777", "from_base": 8, "to_base": 2}, "output": "111111111", "description": "Octal to binary"}
    ]
)
...
@mcp_function(
    ...
    cache_strategy="memory",
    examples=[
        {"input": {"decimal": 64}, "output": "100", "description": "Decimal 64 = Octal 100"},
        {"input": {"decimal": 255}, "output": "377", "description": "Decimal 255 = Octal 377"},
        {"input": {"decimal": 8}, "output": "10", "description": "Decimal 8 = Octal 10"},
...
@mcp_function(
    ...
    cache_strategy="memory",
    examples=[
        {"input": {"octal_str": "100"}, "output": 64, "description": "Octal 100 = Decimal 64"},
        {"input": {"octal_str": "377"}, "output": 255, "description": "Octal 377 = Decimal 255"},
        {"input": {"octal_str": "10"}, "output": 8, "description": "Octal 10 = Decimal 8"},
        {"input": {"octal_str": "0"}, "output": 0, "description": "Octal 0 = Decimal 0"}
    ]
)
...
@mcp_function(
    ...
    cache_strategy="memory",
    examples=[
        {"input": {"decimal": 255}, "output": "FF", "description": "Decimal 255 = Hex FF"},
        {"input": {"decimal": 16}, "output": "10", "description": "Decimal 16 = Hex 10"},
        {"input": {"decimal": 171}, "output": "AB", "description": "Decimal 171 = Hex AB"},
...
@mcp_function(
    ...
    cache_strategy="memory",
    examples=[
        {"input": {"hex_str": "FF"}, "output": 255, "description": "Hex FF = Decimal 255"},
        {"input": {"hex_str": "10"}, "output": 16, "description": "Hex 10 = Decimal 16"},
        {"input": {"hex_str": "AB"}, "output": 171, "description": "Hex AB = Decimal 171"},
...
@mcp_function(
    ...
    execution_modes=["local", "remote"],
    examples=[
        {"input": {"start": 1, "end": 5}, "output": [1, 2, 3, 4, 5], "description": "Natural numbers 1 to 5"},
        {"input": {"start": 10, "end": 12}, "output": [10, 11, 12], "description": "Natural numbers 10 to 12"},
        {"input": {"start": 1, "end": 1}, "output": [1], "description": "Single natural number"},
        {"input": {"start": 5, "end": 3}, "output": [], "description": "Invalid range returns empty"}
    ]
)
...
@mcp_function(
    ...
    execution_modes=["local", "remote"],
    examples=[
        {"input": {"start": 0, "end": 5}, "output": [0, 1, 2, 3, 4, 5], "description": "Whole numbers 0 to 5"},
        {"input": {"start": 3, "end": 7}, "output": [3, 4, 5, 6, 7], "description": "Whole numbers 3 to 7"},
        {"input": {"start": 0, "end": 0}, "output": [0], "description": "Just zero"},
        {"input": {"start": 5, "end": 2}, "output": [], "description": "Invalid range returns empty"}
    ]
)
...
@mcp_function(
    ...
    execution_modes=["local", "remote"],
    examples=[
        {"input": {"start": -3, "end": 3}, "output": [-3, -2, -1, 0, 1, 2, 3], "description": "Integers from -3 to 3"},
        {"input": {"start": -5, "end": -2}, "output": [-5, -4, -3, -2], "description": "Negative integers"},
        {"input": {"start": 2, "end": 5}, "output": [2, 3, 4, 5], "description": "Positive integers"},
        {"input": {"start": 0, "end": 0}, "output": [0], "description": "Just zero"}
    ]
)
...
@mcp_function(
    ...
    execution_modes=["local", "remote"],
    examples=[
        {"input": {"number": "1010", "base": 2}, "output": True, "description": "Valid binary number"},
        {"input": {"number": "129", "base": 2}, "output": False, "description": "Invalid binary (contains 2 and 9)"},
        {"input": {"number": "ABC", "base": 16}, "output": True, "description": "Valid hexadecimal"},
        {"input": {"number": "XYZ", "base": 16}, "output": False, "description": "Invalid hexadecimal"}
    ]
)
...
@mcp_function(
    ...
    estimated_cpu_usage="medium",
    examples=[
        {"input": {"num1": "1010", "num2": "1100", "base": 2}, "output": "10110", "description": "Binary addition"},
        {"input": {"num1": "FF", "num2": "1", "base": 16}, "output": "100", "description": "Hexadecimal addition"},
        {"input": {"num1": "777", "num2": "1", "base": 8}, "output": "1000", "description": "Octal addition"},
        {"input": {"num1": "99", "num2": "1", "base": 10}, "output": "100", "description": "Decimal addition"}
    ]
)
...
@mcp_function(
    ...
    estimated_cpu_usage="medium",
    examples=[
        {"input": {"num1": "101", "num2": "11", "base": 2}, "output": "1111", "description": "Binary multiplication"},
        {"input": {"num1": "A", "num2": "B", "base": 16}, "output": "6E", "description": "Hexadecimal multiplication"},
        {"input": {"num1": "12", "num2": "34", "base": 8}, "output": "450", "description": "Octal multiplication"},
        {"input": {"num1": "12", "num2": "34", "base": 10}, "output": "408", "description": "Decimal multiplication"}
    ]
)
...
__all__ = [
    ...
    # Number type generators
    'natural_numbers', 'whole_numbers', 'integers_in_range',
    
    # Validation
    'validate_number_in_base', 'is_valid_base',
    
    # Arithmetic in different bases
    'add_in_base', 'multiply_in_base'
]
