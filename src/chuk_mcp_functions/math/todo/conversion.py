#!/usr/bin/env python3
# chuk_mcp_functions/math/conversion.py
"""
...
@mcp_function(
    ...
    examples=[
        {"input": {"value": 100, "from_scale": "celsius", "to_scale": "fahrenheit"}, "output": {"result": 212.0, "formula": "C × 9/5 + 32"}, "description": "Boiling point conversion"},
        {"input": {"value": 32, "from_scale": "fahrenheit", "to_scale": "celsius"}, "output": {"result": 0.0, "formula": "(F - 32) × 5/9"}, "description": "Freezing point conversion"},
        {"input": {"value": 273.15, "from_scale": "kelvin", "to_scale": "celsius"}, "output": {"result": 0.0, "formula": "K - 273.15"}, "description": "Absolute zero conversion"}
    ]
)
def convert_temperature(value: Union[int, float], from_scale: str, to_scale: str) -> Dict[str, Any]:
    """
    ...
    if to_scale == "fahrenheit":
        ...
        formula = "(C + 273.15) × 9/5" if from_scale == "celsius" else "(converted to C + 273.15) × 9/5"
...
@mcp_function(
    ...
    cache_strategy="memory",
    examples=[
        {"input": {"value": 1, "from_unit": "meter", "to_unit": "feet"}, "output": 3.281, "description": "1 meter to feet"},
        {"input": {"value": 5, "from_unit": "feet", "to_unit": "inches"}, "output": 60, "description": "5 feet to inches"},
        {"input": {"value": 1, "from_unit": "kilometer", "to_unit": "mile"}, "output": 0.621, "description": "1 km to miles"}
    ]
)
def convert_length(value: Union[int, float], from_unit: str, to_unit: str) -> float:
    """
...
@mcp_function(
    ...
    cache_strategy="memory",
    examples=[
        {"input": {"value": 1, "from_unit": "kilogram", "to_unit": "pound"}, "output": 2.205, "description": "1 kg to pounds"},
        {"input": {"value": 16, "from_unit": "ounce", "to_unit": "pound"}, "output": 1.0, "description": "16 oz to 1 pound"},
        {"input": {"value": 1000, "from_unit": "gram", "to_unit": "kilogram"}, "output": 1.0, "description": "1000g to 1kg"}
    ]
)
def convert_weight(value: Union[int, float], from_unit: str, to_unit: str) -> float:
    """
...
@mcp_function(
    ...
    cache_strategy="memory",
    examples=[
        {"input": {"value": 1, "from_unit": "square_meter", "to_unit": "square_feet"}, "output": 10.764, "description": "1 m² to ft²"},
        {"input": {"value": 1, "from_unit": "acre", "to_unit": "hectare"}, "output": 0.405, "description": "1 acre to hectares"},
        {"input": {"value": 1, "from_unit": "hectare", "to_unit": "square_meter"}, "output": 10000, "description": "1 hectare to m²"}
    ]
)
def convert_area(value: Union[int, float], from_unit: str, to_unit: str) -> float:
    """
...
@mcp_function(
    ...
    cache_strategy="memory",
    examples=[
        {"input": {"value": 1, "from_unit": "liter", "to_unit": "gallon"}, "output": 0.264, "description": "1 liter to US gallons"},
        {"input": {"value": 1, "from_unit": "cubic_meter", "to_unit": "liter"}, "output": 1000, "description": "1 m³ to liters"},
        {"input": {"value": 1, "from_unit": "gallon", "to_unit": "liter"}, "output": 3.785, "description": "1 US gallon to liters"}
    ]
)
...
@mcp_function(
    ...
    cache_strategy="memory",
    examples=[
        {"input": {"value": 1, "from_unit": "hour", "to_unit": "minute"}, "output": 60, "description": "1 hour to minutes"},
        {"input": {"value": 1, "from_unit": "day", "to_unit": "hour"}, "output": 24, "description": "1 day to hours"},
        {"input": {"value": 1, "from_unit": "week", "to_unit": "day"}, "output": 7, "description": "1 week to days"}
    ]
)
...
@mcp_function(
    ...
    cache_strategy="memory",
    examples=[
        {"input": {"value": 60, "from_unit": "mph", "to_unit": "kph"}, "output": 96.56, "description": "60 mph to kph"},
        {"input": {"value": 100, "from_unit": "kph", "to_unit": "mph"}, "output": 62.14, "description": "100 kph to mph"},
        {"input": {"value": 10, "from_unit": "m/s", "to_unit": "kph"}, "output": 36.0, "description": "10 m/s to kph"}
    ]
)
def convert_speed(value: Union[int, float], from_unit: str, to_unit: str) -> float:
    """
...
__all__ = [
    'convert_temperature', 'convert_length', 'convert_weight', 'convert_area',
    'convert_volume', 'convert_time', 'convert_speed'
]
...
if __name__ == "__main__":
    ...
    print(f"convert_weight(1, 'kilogram', 'pound') = {convert_weight(1, 'kilogram', 'pound'):.3f} lbs")
    print(f"convert_area(1, 'square_meter', 'square_feet') = {convert_area(1, 'square_meter', 'square_feet'):.3f} ft²")
