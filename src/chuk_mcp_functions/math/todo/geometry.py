#!/usr/bin/env python3
# chuk_mcp_functions/math/geometry.py
"""
...
@mcp_function(
    ...
    dependencies=["math"],
    examples=[
        {"input": {"radius": 5}, "output": 78.54, "description": "Area of circle with radius 5"},
        {"input": {"radius": 1}, "output": 3.14159, "description": "Area of unit circle"},
        {"input": {"radius": 10}, "output": 314.16, "description": "Area of larger circle"}
    ]
)
...
@mcp_function(
    ...
    dependencies=["math"],
    examples=[
        {"input": {"radius": 5}, "output": 31.42, "description": "Circumference of circle with radius 5"},
        {"input": {"radius": 1}, "output": 6.28, "description": "Circumference of unit circle"},
        {"input": {"radius": 3}, "output": 18.85, "description": "Circumference with radius 3"}
    ]
)
def circle_circumference(radius: Union[int, float]) -> float:
    ...
    Examples:
        ...
        circle_circumference(1) → 6.283185307179586
        circle_circumference(3) → 18.84955592153876
    """
    if radius < 0:
        raise ValueError("Radius cannot be negative")
...
@mcp_function(
    ...
    execution_modes=["local", "remote"],
    examples=[
        {"input": {"length": 5, "width": 3}, "output": 15, "description": "5×3 rectangle area"},
        {"input": {"length": 10, "width": 2.5}, "output": 25.0, "description": "Rectangle with decimal width"},
        {"input": {"length": 7, "width": 7}, "output": 49, "description": "Square area (special rectangle)"}
    ]
)
...
@mcp_function(
    ...
    execution_modes=["local", "remote"],
    examples=[
        {"input": {"length": 5, "width": 3}, "output": 16, "description": "Perimeter of 5×3 rectangle"},
        {"input": {"length": 10, "width": 2.5}, "output": 25.0, "description": "Perimeter with decimal dimensions"},
        {"input": {"length": 4, "width": 4}, "output": 16, "description": "Perimeter of square"}
    ]
)
...
@mcp_function(
    ...
    execution_modes=["local", "remote"],
    examples=[
        {"input": {"base": 6, "height": 4}, "output": 12.0, "description": "Triangle with base 6, height 4"},
        {"input": {"base": 10, "height": 5}, "output": 25.0, "description": "Triangle with base 10, height 5"},
        {"input": {"base": 3.5, "height": 2}, "output": 3.5, "description": "Triangle with decimal base"}
    ]
)
...
@mcp_function(
    ...
    dependencies=["math"],
    examples=[
        {"input": {"a": 3, "b": 4, "c": 5}, "output": 6.0, "description": "Area of 3-4-5 right triangle"},
        {"input": {"a": 5, "b": 5, "c": 6}, "output": 12.0, "description": "Area of isosceles triangle"},
        {"input": {"a": 7, "b": 8, "c": 9}, "output": 26.83, "description": "Area of scalene triangle"}
    ]
)
def triangle_area_heron(a: Union[int, float], b: Union[int, float], c: Union[int, float]) -> float:
    """
...
@mcp_function(
    ...
    cache_strategy="memory",
    examples=[
        {"input": {"x1": 0, "y1": 0, "x2": 3, "y2": 4}, "output": 5.0, "description": "Distance from origin to (3,4)"},
        {"input": {"x1": 1, "y1": 1, "x2": 4, "y2": 5}, "output": 5.0, "description": "Distance between (1,1) and (4,5)"},
        {"input": {"x1": -2, "y1": 3, "x2": 1, "y2": -1}, "output": 5.0, "description": "Distance with negative coordinates"}
    ]
)
...
@mcp_function(
    ...
    cache_strategy="memory",
    examples=[
        {"input": {"x1": 0, "y1": 0, "z1": 0, "x2": 1, "y2": 1, "z2": 1}, "output": 1.732, "description": "Distance from origin to (1,1,1)"},
        {"input": {"x1": 1, "y1": 2, "z1": 3, "x2": 4, "y2": 5, "z2": 6}, "output": 5.196, "description": "Distance between two 3D points"}
    ]
)
...
@mcp_function(
    ...
    cache_strategy="memory",
    examples=[
        {"input": {"a": 3, "b": 4}, "output": 5.0, "description": "Classic 3-4-5 triangle"},
        {"input": {"a": 5, "b": 12}, "output": 13.0, "description": "5-12-13 triangle"},
        {"input": {"a": 1, "b": 1}, "output": 1.414, "description": "Isosceles right triangle"}
    ]
)
...
@mcp_function(
    ...
    execution_modes=["local", "remote"],
    examples=[
        {"input": {"side": 5}, "output": {"area": 25, "perimeter": 20}, "description": "5×5 square"},
        {"input": {"side": 3.5}, "output": {"area": 12.25, "perimeter": 14.0}, "description": "Square with decimal side"},
        {"input": {"side": 10}, "output": {"area": 100, "perimeter": 40}, "description": "10×10 square"}
    ]
)
def square_properties(side: Union[int, float]) -> Dict[str, Union[int, float]]:
    """
...
@mcp_function(
    ...
    dependencies=["math"],
    examples=[
        {"input": {"radius": 3}, "output": 113.1, "description": "Volume of sphere with radius 3"},
        {"input": {"radius": 1}, "output": 4.19, "description": "Volume of unit sphere"},
        {"input": {"radius": 5}, "output": 523.6, "description": "Volume of larger sphere"}
    ]
)
...
@mcp_function(
    ...
    dependencies=["math"],
    examples=[
        {"input": {"radius": 3}, "output": 113.1, "description": "Surface area of sphere with radius 3"},
        {"input": {"radius": 1}, "output": 12.57, "description": "Surface area of unit sphere"},
        {"input": {"radius": 5}, "output": 314.16, "description": "Surface area of larger sphere"}
    ]
)
...
__all__ = [
    ...
    'triangle_area', 'triangle_area_heron', 'distance_2d', 'distance_3d',
    'hypotenuse', 'square_properties', 'sphere_volume', 'sphere_surface_area'
]
