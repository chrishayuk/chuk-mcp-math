...
async def demo_mathematical_identities():
    ...
    for angle in double_test_angles:
        ...
        print(f"    sin(2×{angle_deg:.0f}°) = {double_sin_formula:.6f} (direct: {double_sin_direct:.6f})")
        print(f"    cos(2×{angle_deg:.0f}°) = {double_cos_formula:.6f} (direct: {double_cos_direct:.6f})")
