...
class TestBasicOperations:
    ...
    async def test_mathematical_correctness_verification(self):
        ...
        assert cf_355_113['cf'] == [3, 7, 16], f"355/113 should be [3, 7, 16], got {cf_355_113['cf']}"
...
class TestParametrized:
    ...
    @pytest.mark.asyncio
    @pytest.mark.parametrize("p,q,expected_cf", [
        (22, 7, [3, 7]),
    ...
    @pytest.mark.asyncio
    @pytest.mark.parametrize("cf,expected_p,expected_q", [
        ([3, 7], 22, 7),
    ...
    @pytest.mark.asyncio
    @pytest.mark.parametrize("n,expected_solution", [
        (2, [3, 2]),    # x² - 2y² = 1: (3, 2)
        (3, [2, 1]),    # x² - 3y² = 1: (2, 1)
        (5, [9, 4]),    # x² - 5y² = 1: (9, 4)
        (7, [8, 3]),    # x² - 7y² = 1: (8, 3)
