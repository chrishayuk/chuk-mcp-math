...
class TestAmicableNumbers:
    ...
    async def test_find_amicable_pairs_larger_limit(self):
        ...
        expected_pairs = [[220, 284], [1184, 1210], [2620, 2924], [5020, 5564], [6232, 6368]]
...
class TestParametrized:
    ...
    @pytest.mark.asyncio
    @pytest.mark.parametrize("amicable_num,expected_partner", [
        (220, 284),
        (284, 220),
        (1184, 1210),
        (1210, 1184)
    ...
    async def test_known_amicable_numbers(self, amicable_num, expected_partner):
        ...
        if result["is_amicable"]:
            ...
            assert [min(amicable_num, expected_partner), max(amicable_num, expected_partner)] in pairs
    ...
    @pytest.mark.asyncio
    @pytest.mark.parametrize("vampire_num,expected_fangs", [
        (1260, [[21, 60]]),
        (1395, [[15, 93]]),
        (1435, [[35, 41]])
    ])
    ...
    @pytest.mark.asyncio
    @pytest.mark.parametrize("n,expected_constant", [
        (3, 15),
        (4, 34),
        (5, 65),
        (6, 111)
