...
class TestLessThanOrEqual:
    ...
    async def test_less_than_or_equal_consistency(self):
        ...
        test_pairs = [(3, 5), (5, 3), (5, 5), (-2, 1), (3.14, 3.15)]
...
class TestGreaterThan:
    ...
    async def test_greater_than_consistency_with_less_than(self):
        ...
        test_pairs = [(5, 3), (3, 5), (5, 5), (-2, 1), (3.14, 2.71)]
...
class TestGreaterThanOrEqual:
    ...
    async def test_greater_than_or_equal_consistency(self):
        ...
        test_pairs = [(5, 3), (3, 5), (5, 5), (1, -2), (3.15, 3.14)]
...
class TestIntegration:
    ...
    async def test_range_operations_consistency(self):
        ...
        test_cases = [(5, 1, 10), (1, 1, 10), (10, 1, 10), (0, 1, 10), (11, 1, 10)]
        ...
        for value, min_val, max_val in test_cases:
            ...
            manual_check_inclusive = await less_than_or_equal(
                min_val, value
            ) and await less_than_or_equal(value, max_val)
...
class TestPerformance:
    ...
    async def test_concurrent_execution(self):
        ...
        tasks = [equal(i, i) for i in range(100)]
...
class TestParametrized:
    ...
    @pytest.mark.parametrize(
        "a,b,expected_equal,expected_less,expected_greater",
        [
    ...
    async def test_basic_comparisons_parametrized(
        self, a, b, expected_equal, expected_less, expected_greater
    ):
    ...
    @pytest.mark.asyncio
    @pytest.mark.parametrize(
        "value,min_val,max_val,expected_inclusive,expected_exclusive",
        [
    ...
    async def test_range_operations_parametrized(
