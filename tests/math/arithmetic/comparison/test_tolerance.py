...
class TestIntegration:
    ...
    async def test_tolerance_function_relationships(self):
        ...
        test_pairs = [(1.0, 1.001), (0.0, 1e-10), (-5.5, -5.5001), (1e6, 1e6 + 100)]
...
class TestParametrized:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                ...
                1e-9,
                False,
            ),  # Fixed: Infinity comparison fails due to nan
    ...
    @pytest.mark.asyncio
    @pytest.mark.parametrize(
        "value,expected_finite,expected_nan,expected_infinite",
        [
    ...
    async def test_special_value_detection_parametrized(
        self, value, expected_finite, expected_nan, expected_infinite
    ):
