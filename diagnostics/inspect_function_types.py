...
async def inspect_function_types():
    ...
    try:
        ...
        from chuk_mcp_functions.math.arithmetic.number_theory import is_prime, factorial, fibonacci
...
async def test_async_calls():
    ...
    try:
        ...
        from chuk_mcp_functions.math.arithmetic.number_theory import is_prime, fibonacci
        ...
        if coroutines:
            ...
            print(f"   ❌ No coroutines to gather!")
